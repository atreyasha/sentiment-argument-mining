...
def project_to_ids(Tokenizer,data,max_seq_length=512):
    ...
    return np.array(input_ids), np.array(output_mask)
...
def corpus2tokenids(max_seq_length=512,
    ...
    input_ids, input_mask = project_to_ids(Tokenizer,collection,
                              max_seq_length)
