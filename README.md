...
For argumentation mining, we train an argument candidate classifier on the US Election Debate [corpus](https://www.aclweb.org/anthology/P19-1463/), which can is available to the public [here](https://github.com/ElecDeb60To16/Dataset). Next, we apply this classifier on the UNSC corpus to check if we can extract meaningful argumentation candidates.
